...
export const SearchPlaceInput = () => {
  ...
  return (
    <>
      <form className="relative w-3/4 my-14 [&>div]:border-b [&>div]:border-airpalsGreyBackground max-w-xl">
        ...
        <div className="absolute z-10 w-full max-h-[300%] overflow-y-auto">
